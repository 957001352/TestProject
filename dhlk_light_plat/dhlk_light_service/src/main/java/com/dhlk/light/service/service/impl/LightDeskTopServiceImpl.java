...
import com.dhlk.light.service.dao.LightDeskTopDao;
 ...
 **/
@Service
public class LightDeskTopServiceImpl implements LightDeskTopService {

    @Autowired
    private LightDeskTopDao deskTopDao;
    @Autowired
