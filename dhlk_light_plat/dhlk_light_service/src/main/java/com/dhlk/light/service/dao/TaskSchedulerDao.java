...
public interface TaskSchedulerDao {
     ...
     * @return 定时任务
     */
    public List<TaskScheduler> selectTaskSchedulerByTenantId(@Param("tenantId") Integer tenantId);

    /**
     * 根据租户Id获取TaskScheduler
     *
     * @param tenantId
     * @return
     */
    List<TaskScheduler> findListByTenantId(Integer tenantId);
}
