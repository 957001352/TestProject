...
public interface OriginalPowerDao {
     ...
     * @return
     */
    Integer updateOriginalPower(@Param("preBrightness") Integer preBrightness, @Param("tenantId") Integer tenantId,@Param("systemRunTime") String systemRunTime);
    ...
    Integer setValues(@Param("ledCount")Integer ledCount, @Param("ledOpentime")Float ledOpentime, @Param("ledPower")Float ledPower, @Param("tenantId")Integer tenantId,@Param("preBrightness")Integer brightness);
     ...
     * @return
     */
    Integer insertBatch(List<OriginalPower> originalPower);
